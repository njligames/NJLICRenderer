...
static const ColorInfo color_data[COLOR_NAMES_MAX] = {
...
glm::vec3 Util::color(const Color &color) {

    return glm::vec3(color_data[static_cast<int>(color)].rgb.r / 255.f,
                     color_data[static_cast<int>(color)].rgb.b / 255.f,
                     color_data[static_cast<int>(color)].rgb.g / 255.f );
